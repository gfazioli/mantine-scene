...
### Meteor shower preset

Bump `count` and tighten the `minInterval`/`maxInterval` window to turn a quiet
ambient sky into a steady meteor rain — same primitive, different cadence.

<Demo data={demos.meteorShower} />
